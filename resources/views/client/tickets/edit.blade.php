    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-6 transition transform duration-500 hover:scale-[1.01]">
                ...
                <form method="POST" action="{{ route('client.tickets.update', $ticket->id) }}" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    @method('PUT')
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" required
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 transition focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-300">{{ old('description', $ticket->description) }}</textarea>
                    </div>
